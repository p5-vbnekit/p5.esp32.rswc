...
function("${_cmake_module_namespace}::_initialize")
    ...
    mark_as_advanced("_target_namespace")
    ...
    if("${_base_path}" STREQUAL "${CMAKE_CURRENT_SOURCE_DIR}")
        ...
        get_filename_component("_target_namespace" "${_base_path}" NAME)
        add_library("${_target_namespace}.romfs_image_layout" STATIC "${_image_layout_path}")
        add_library("${_target_namespace}::romfs_image_layout" ALIAS "${_target_namespace}.romfs_image_layout")
    endif()
endfunction()
